...
public class ArticlesController : Controller
{
    ...
    public async Task<IActionResult> Create(CreateArticleViewModel viewModel, CancellationToken cancellationToken)
    {
        ...
        var article = new Article
        {
            ...
            AuthorId = User.FindFirstValue(ClaimTypes.NameIdentifier) // Seteaza automat autorul logat
        };
    ...
    public async Task<IActionResult> Delete(int? id, CancellationToken cancellationToken)
    {
        ...
        // Verificam daca utilizatorul are dreptul sa stearga   
        if (!IsOwnerOrAdmin(article))
            return Forbid();
    ...
    // Helper privat pentru verificarea permisiunilor
